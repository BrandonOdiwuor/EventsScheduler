defmodule EventsScheduler.StudentControllerTest do
  use EventsScheduler.ConnCase

  alias EventsScheduler.Student
  @valid_attrs %{email: "some content", encrypted_password: "some content", name: "some content", year: 42}
  @invalid_attrs %{}
